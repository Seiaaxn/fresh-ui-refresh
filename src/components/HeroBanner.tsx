...
/**
 * Banner 16:9 ala KyzzAPI — gambar lebar dengan overlay gradient,
 * chip label, dan caption di kiri bawah.
 */
export function HeroBanner({
  ...
  return (
    <section className="glass-card animate-rise group relative mt-8 overflow-hidden p-0">
